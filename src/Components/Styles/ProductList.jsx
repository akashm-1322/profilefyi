                    ...
                    <div className="col-md-4 mb-4" key={index}>
                        <div className="card h-100">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Discounted Price: <b>₹{product.price - (product.discountPercentage * 0.01 * product.price)}</b></p>
                                <p className="card-text">Items Left: {product.stock}</p>
                                <div className="button-flex">
                                    <button className="btn btn-primary" onClick={() => addToCart(product)}>Add To Cart</button>
                                    <button className="btn btn-primary" onClick={() => window.open(product.features, '_blank')}>View Specs site</button>
                                </div>
                            </div>
                        </div>
                    </div>
